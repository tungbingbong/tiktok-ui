                        ...
                        <div className={cx('box-uploader')}>
                            ...
                            <div className={cx('box-command')}>
                                <div className={cx('box-command-caption')}>
                                    ...
                                    />
                                    <span className={cx('box-command-caption-limited')}>{caption.length} / 150</span>
                                </div>
                                ...
                                <div className={cx('box-command-limited')}>
                                    ...
                                    <select className={cx('box-command-limited-options')} name="privacy" id="privacy">
                                ...
                                <div className={cx('box-command-approach')}>
                                    ...
                                    <div className={cx('box-command-approach-permission')}>
                                        <div className={cx('box-command-approach-choice')}>
                                            ...
                                            />
                                            <label className={cx('box-command-approach-choice-name')} htmlFor="comment">
                                                Comment
                                            </label>
                                        </div>
                                        <div className={cx('box-command-approach-choice')}>
                                            <input
                                                ...
                                                className={cx('box-command-approach-choice-input')}
                                            />
                                            <label className={cx('box-command-approach-choice-name')} htmlFor="duet">
                                                Duet
                                            </label>
                                        </div>
                                        <div className={cx('box-command-approach-choice')}>
                                            <input
                                                ...
                                                className={cx('box-command-approach-choice-input')}
                                            />
                                            <label className={cx('box-command-approach-choice-name')} htmlFor="stitch">
                                                Stitch
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div className={cx('box-command-copyright')}>
                                    <div className={cx('box-command-copyright-check')}>
                                        <label className={cx('box-command-copyright-check-title')} htmlFor="privacy">
